...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [2179791.707557, 5774720.400424, 2357062.690027, 5919716.401324], maxZoom: 11, minZoom: 6
    })
});
...
map.getView().fit([2179791.707557, 5774720.400424, 2357062.690027, 5919716.401324], map.getSize());
